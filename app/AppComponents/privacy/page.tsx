  ...
  return (
    ...
    >
      ...
      <section className="relative w-full py-20 text-center z-10">
        ...
        >
          At <strong>Quick Task</strong>, your privacy is our top priority.  
          Learn how we safeguard your data and respect your rights.
        </p>
      </section>
        ...
        {[
          {
            ...
            desc: "We may collect personal information such as your name, email address, and usage data when you register or use our services.",
          },
          {
            icon: Lock,
            title: "How We Use Information",
            desc: "We use the collected data to provide and improve our services, personalize your experience, and ensure the security of our platform.",
          },
          {
            icon: UserCheck,
            title: "Your Rights",
            desc: "You have the right to access, update, or delete your personal data. Please contact us if you wish to exercise these rights.",
          },
          {
            icon: Mail,
            title: "Contact Us",
